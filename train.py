...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default='/Users/apple/Desktop/NST_code/content_data',
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default='/Users/apple/Desktop/NST_code/style_data',
                        help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default='/Users/apple/Desktop/NST_code/vgg_normalised.pth',
